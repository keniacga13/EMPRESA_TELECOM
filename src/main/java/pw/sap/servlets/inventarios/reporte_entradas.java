...
import pw.sap.pojo.Inventarios.ReporteEn;

/**
 *
 * @author Emilio Gorostieta
 */
@WebServlet(name = "reporte_entradas", urlPatterns = {"/reporte_entradas"})
public class reporte_entradas extends HttpServlet {
