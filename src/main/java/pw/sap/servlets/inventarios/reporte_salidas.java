...
import pw.sap.pojo.Inventarios.ReporteSa;

/**
 *
 * @author Emilio Gorostieta
 */
@WebServlet(name = "reporte_salidas", urlPatterns = {"/reporte_salidas"})
public class reporte_salidas extends HttpServlet {
/**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("Inventarios/Inventario/SalidasporOrd");
