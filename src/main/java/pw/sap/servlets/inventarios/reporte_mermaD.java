...
import pw.sap.pojo.Inventarios.ReporteMD;

/**
 *
 * @author Adrian
 */
@WebServlet(name = "reporte_mermaD ", urlPatterns ={  "/reporte_mermaD "})
public class reporte_mermaD extends HttpServlet
{
   ...
   /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("Inventarios/Inventario/merma2.jsp");
